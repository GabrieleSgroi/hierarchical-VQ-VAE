...
def build_indicization_model():
    ...
    top_codebook=load_utils.get_codebook(top_quantizer)
    mid_codebook=load_utils.get_codebook(mid_quantizer)
    bot_codebook=load_utils.get_codebook(bot_quantizer)
